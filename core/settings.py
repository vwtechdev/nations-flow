...
# de forms. Sem isso, os widgets usam um engine próprio que só olha APP_DIRS,
# impedindo os overrides de template do reCAPTCHA.
...
# Logging otimizado para produção com Nginx
LOGGING = {
    'version': 1,
